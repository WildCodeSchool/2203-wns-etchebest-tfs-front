...
export default function Button(props: Properties): ReactElement {
	...
	let classes = classNames(
		`relative flex min-h-14 border justify-center border-transparent text-sm duration-100 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-offset-2  px-6 py-3 disabled:text-grey-500 disabled:bg-grey-300 disabled:hover:bg-grey-300 flex items-center gap-1`,
