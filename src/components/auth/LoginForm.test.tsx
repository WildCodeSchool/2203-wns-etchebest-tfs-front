...
const loginMock = [
	{
		...
		result: {
			data: {
				login:
					'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImdtQHRlc3QuY29tIiwiaWF0IjoxNjYzODYwODYxLCJleHAiOjE2NjM4NjQ0NjF9.Bk_1YWiA3Ob04tzlHfps0Z83gKC5kTWcLIl3ZAAwKoQ'
			}
		}
	}
]
